...
function OwnInMessage(props)
{
    const dispatch = useDispatch();
    const state = useSelector(({ownin}) => ownin.message.state);
    const options = useSelector(({ownin}) => ownin.message.options);
...
export default React.memo(OwnInMessage);
