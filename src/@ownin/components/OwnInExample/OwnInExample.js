...
import {OwnInHighlight} from '@ownin';
                ...
                <div className={currentTab === 1 ? 'flex flex-1' : 'hidden'}>
                    {raw && (
                        <div className="flex flex-1">
                            <OwnInHighlight component="pre" className="language-javascript w-full">
                                {raw}
                            </OwnInHighlight>
                        </div>
                    )}
...
OwnInExample.propTypes = propTypes;
OwnInExample.defaultProps = defaultProps;

export default OwnInExample;
