...
import OwnInPageCardedSidebarContent from './OwnInPageCardedSidebarContent';

function OwnInPageCardedSidebar(props, ref)
{
    ...
    return (
        <React.Fragment>
            <Hidden lgUp={props.variant === 'permanent'}>
                ...
                >
                    <OwnInPageCardedSidebarContent {...props}/>
                </Drawer>
            </Hidden>
...
export default React.forwardRef(OwnInPageCardedSidebar);
