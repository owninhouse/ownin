...
import OwnInPageCardedSidebar from './OwnInPageCardedSidebar';
import OwnInPageCardedHeader from './OwnInPageCardedHeader';
...
const OwnInPageCarded = React.forwardRef(function (props, ref) {
        ...
        <div className={clsx(classes.root, props.innerScroll && classes.innerScroll)} ref={rootRef}>
            ...
            <div className="flex container w-full">
                ...
                >
                    ...
                    <OwnInPageCardedHeader header={props.header} classes={classes}/>
                    ...
                    <div className={clsx(classes.contentCard, props.innerScroll && 'inner-scroll')}>
                        ...
                        {props.content && (
                            <OwnInScrollbars className={classes.content} enable={props.innerScroll} scrollToTopOnChildChange={props.innerScroll}>
                                {props.content}
                            </OwnInScrollbars>
                        )}
                    </div>
...
OwnInPageCarded.defaultProps = {};

export default React.memo(OwnInPageCarded);
