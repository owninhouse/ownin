...
import OwnInPageSimpleSidebar from './OwnInPageSimpleSidebar';
import OwnInPageSimpleHeader from './OwnInPageSimpleHeader';
...
const OwnInPageSimple = React.forwardRef(function (props, ref) {
    // console.info("render::OwnInPageSimple");
        ...
        <div className={clsx(classes.root, props.innerScroll && classes.innerScroll)} ref={rootRef}>
            ...
            <div className="flex flex-auto flex-col container z-10">
                ...
                {props.header && props.sidebarInner && (
                    <OwnInPageSimpleHeader header={props.header} classes={classes}/>
                )}

                <div className={classes.wrapper}>

                    {(props.leftSidebarHeader || props.leftSidebarContent) && (
                        <OwnInPageSimpleSidebar
                            position="left"
                    ...
                    {/*>*/}
                    <OwnInScrollbars className={classes.contentWrapper} enable={props.innerScroll && !props.sidebarInner}>
...
OwnInPageSimple.defaultProps = {};

export default React.memo(OwnInPageSimple);
