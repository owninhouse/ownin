...
import OwnInPageSimpleSidebarContent from './OwnInPageSimpleSidebarContent';

function OwnInPageSimpleSidebar(props, ref)
{
    ...
    return (
        <React.Fragment>
            <Hidden lgUp={props.variant === 'permanent'}>
                ...
                >
                    <OwnInPageSimpleSidebarContent {...props}/>
                </Drawer>
            </Hidden>
...
export default React.forwardRef(OwnInPageSimpleSidebar);
