...
const OwnInScrollbars = React.forwardRef(function OwnInScrollbars(props, ref) {
    ref = ref || createRef();
...
function mapStateToProps({ownin})
{
    return {
        customScrollbars: ownin.settings.current.customScrollbars
    }
}

OwnInScrollbars.propTypes = {
...
export default connect(mapStateToProps, null, null, {forwardRef: true})(React.memo(OwnInScrollbars));
