...
import {OwnInLayouts} from '@ownin';
...
function OwnInLayout(props)
{
    const dispatch = useDispatch();
    const defaultSettings = useSelector(({ownin}) => ownin.settings.defaults);
    ...
    // console.warn('OwnInLayout:: rendered');

    const Layout = OwnInLayouts[settings.layout.style];
    return (
        <Layout classes={{root: classes.root}} {...props}/>
    );
}

export default withRouter(React.memo(OwnInLayout));
