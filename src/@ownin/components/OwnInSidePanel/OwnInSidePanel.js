        ...
        <React.Fragment>
            <Hidden mdDown>
                <Paper
                    ...
                    square={true}
                >
                    <OwnInScrollbars className={clsx("content", classes.content)}>
                        {props.children}
                    </OwnInScrollbars>
...
OwnInSidePanel.propTypes = {};
OwnInSidePanel.defaultProps = {
    position: "left",
    opened  : true
};

export default React.memo(OwnInSidePanel);
