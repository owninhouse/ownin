...
function OwnInNavVerticalLink(props)
{
...
OwnInNavVerticalLink.propTypes = {
...
OwnInNavVerticalLink.defaultProps = {};

const NavVerticalLink = withRouter(React.memo(OwnInNavVerticalLink));
