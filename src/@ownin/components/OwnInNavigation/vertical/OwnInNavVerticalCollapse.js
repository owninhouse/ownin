...
import OwnInNavVerticalGroup from './OwnInNavVerticalGroup';
...
function OwnInNavVerticalCollapse(props)
{
    ...
    return (
        <ul className={clsx(classes.root, open && "open")}>
            ...
            >
                ...
                {item.badge && (
                    <OwnInNavBadge className="mr-4" badge={item.badge}/>
                )}
                ...
                <Collapse in={open} className="collapse-children">
                    {
                        item.children.map((item) => (
                            ...
                            <React.Fragment key={item.id}>
                                ...
                                {item.type === 'group' && (
                                    <OwnInNavVerticalGroup item={item} nestedLevel={nestedLevel + 1} active={active}/>
                                )}
                                ...
                                {item.type === 'item' && (
                                    <OwnInNavVerticalItem item={item} nestedLevel={nestedLevel + 1} active={active}/>
                                )}

                                {item.type === 'link' && (
                                    <OwnInNavVerticalLink item={item} nestedLevel={nestedLevel + 1} active={active}/>
                                )}
...
OwnInNavVerticalCollapse.propTypes = {
...
OwnInNavVerticalCollapse.defaultProps = {};

const NavVerticalCollapse = withRouter(React.memo(OwnInNavVerticalCollapse));
