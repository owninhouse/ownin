...
import {NavLinkAdapter, OwnInUtils} from '@ownin';
...
function OwnInNavVerticalItem(props)
{
    ...
    return (
        ...
        >
            ...
            {item.badge && (
                <OwnInNavBadge badge={item.badge}/>
            )}
        </ListItem>
    );
}

OwnInNavVerticalItem.propTypes = {
...
OwnInNavVerticalItem.defaultProps = {};

const NavVerticalItem = withRouter(React.memo(OwnInNavVerticalItem));
