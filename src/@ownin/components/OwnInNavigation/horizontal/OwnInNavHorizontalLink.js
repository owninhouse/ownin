...
function OwnInNavHorizontalLink(props)
{
...
OwnInNavHorizontalLink.propTypes = {
...
OwnInNavHorizontalLink.defaultProps = {};

const NavHorizontalLink = withRouter(React.memo(OwnInNavHorizontalLink));
