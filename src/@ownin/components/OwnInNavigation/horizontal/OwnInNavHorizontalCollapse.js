...
import {useDebounce} from '@ownin/hooks';
...
import OwnInNavHorizontalGroup from './OwnInNavHorizontalGroup';
import OwnInNavHorizontalItem from './OwnInNavHorizontalItem';
import OwnInNavHorizontalLink from './OwnInNavHorizontalLink';
import OwnInNavBadge from './../OwnInNavBadge';
...
function OwnInNavHorizontalCollapse(props)
{
                    ...
                    {({ref}) => (
                        <div ref={ref}>
                            ...
                            >
                                ...
                                {item.badge && (
                                    <OwnInNavBadge className="ml-8 mr-4" badge={item.badge}/>
                                )}
                                                ...
                                                <ul className={clsx(classes.children, "pl-0")}>
                                                    {
                                                        item.children.map((item) => (
                                                            ...
                                                            <React.Fragment key={item.id}>
                                                                ...
                                                                {item.type === 'group' && (
                                                                    <OwnInNavHorizontalGroup item={item} nestedLevel={nestedLevel + 1} dense={dense}/>
                                                                )}
                                                                ...
                                                                {item.type === 'item' && (
                                                                    <OwnInNavHorizontalItem item={item} nestedLevel={nestedLevel + 1} dense={dense}/>
                                                                )}

                                                                {item.type === 'link' && (
                                                                    <OwnInNavHorizontalLink item={item} nestedLevel={nestedLevel + 1} dense={dense}/>
                                                                )}
...
OwnInNavHorizontalCollapse.propTypes = {
...
OwnInNavHorizontalCollapse.defaultProps = {};

const NavHorizontalCollapse = withRouter(React.memo(OwnInNavHorizontalCollapse));
