...
function OwnInHighlight(props)
{
    ...
    function trimCode()
    {
        ...
        // can be formatted properly while using ownin-highlight
        // component
...
OwnInHighlight.propTypes = {
    component: PropTypes.node
};
OwnInHighlight.defaultProps = {
    component: `code`
};

export default React.memo(OwnInHighlight);
