...
import {OwnInScrollbars, OwnInSettings} from '@ownin';
...
function SettingsPanel()
{
    ...
    return (
        <React.Fragment>
            <Button id="ownin-settings" className={classes.button} variant="contained" onClick={handleOpen}>
            ...
            >
                <OwnInScrollbars className="p-24 sm:p-32">
