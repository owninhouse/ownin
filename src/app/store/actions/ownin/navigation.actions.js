...
export function appendNavigationItem(item, parentId)
{
    return (dispatch, getState) => {
        const {navigation} = getState().ownin;
        return dispatch({
            type      : SET_NAVIGATION,
            navigation: OwnInUtils.appendNavItem(navigation, item, parentId)
        });
    }
}
...
export function prependNavigationItem(item, parentId)
{
    return (dispatch, getState) => {
        ...
        return dispatch({
            type      : SET_NAVIGATION,
            navigation: OwnInUtils.prependNavItem(navigation, item, parentId)
        });
    }
}
...
export function updateNavigationItem(id, item)
{
    return (dispatch, getState) => {
        ...
        return dispatch({
            type      : SET_NAVIGATION,
            navigation: OwnInUtils.updateNavItem(navigation, id, item)
        });
    }
}
...
export function removeNavigationItem(id)
{
    return (dispatch, getState) => {
        ...
        return dispatch({
            type      : SET_NAVIGATION,
            navigation: OwnInUtils.removeNavItem(navigation, id)
        });
    }
}
